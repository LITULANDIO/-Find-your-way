...
module.exports = (req, res) => {
  ...
  const { tags } = req.body
  const retiro = new Retiro({ title, category, imageUrl, road, comunity, localitation, lat, long, startDate, timeHourStart, timeMinuteStart, endDate, timeHourEnd, timeMinuteEnd, description, tags })
