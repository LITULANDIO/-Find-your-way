...
module.exports = (req, res) => {
  ...
  Retiro.findByIdAndUpdate(id, {title, category, mision, imageUrl, road, comunity, localitation, lat, long, startDate, timeHourStart, timeMinuteStart, endDate, timeHourEnd, timeMinuteEnd, description, price, tel, web, tags })
    .then(retiros => {
